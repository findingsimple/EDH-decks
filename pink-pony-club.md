...
## Notes
**Strategy:** Cast Pegasus, Unicorn, and Horse creatures to trigger Thurid's copy ability, doubling every tribal creature spell into a token copy. The +1/+1 lord effect stacks with anthems to make the board lethal quickly.
...
**Win Conditions:**
- Go wide with doubled creatures and anthem effects (Spear of Heliod, Heraldic Banner, Inspiring Unicorn)
- Storm Herd for a massive burst of Pegasus tokens
...
- **Guardian Sunmare** (saddled: tutor a nonland permanent MV 3 or less to the battlefield) priorities:
  ...
  - **Angelic Destiny** (3 mana aura) when Thurid needs protection and a flying/first-strike boost.
